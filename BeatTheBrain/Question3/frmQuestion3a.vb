...
'\\ Date: 10/03/2020
'\\ Version: VB.net 2017
Public Class frmQuestion3a
    Private Sub frmQuestion3a_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr3a.Tick
        '\\ Label Timer Display
