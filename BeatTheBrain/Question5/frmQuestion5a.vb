...
'\\ Date: 10/03/2020
'\\ Version: VB.net 2017
Public Class frmQuestion5a
    Private Sub frmQuestion5a_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr5a.Tick
        '\\ Label Timer Display
