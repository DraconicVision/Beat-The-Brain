...
Public Class frmQuestion3b
    Private Sub frmQuestion3b_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr3b.Tick
        '\\ Label Timer Display
