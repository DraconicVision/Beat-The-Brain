...
Public Class frmQuestion2a
    Private Sub frmQuestion2a_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr2a.Tick
        '\\ Label Timer Display
