...
'\\ Date: 10/03/2020
'\\ Version: VB.net 2017
Public Class frmQuestion4b
    Private Sub frmQuestion4b_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr4b.Tick
        '\\ Label Timer Display
