...
'\\ Date: 10/03/2020
'\\ Version: VB.net 2017
Public Class frmQuestion2b
    Private Sub frmQuestion2b_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Timer Stop
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr2b.Tick
        '\\ Label Timer Display
