...
Public Class frmQuestion4
    Private Sub frmQuestion4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '\\ Start Timer
    ...
    Private Sub tmrCount_Tick(sender As Object, e As EventArgs) Handles tmr4.Tick
        '\\ Label Timer Display
